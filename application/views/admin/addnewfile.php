...
<html>
	...
	<body>
		...
		<div class="containerko">
			<a href="<?php echo base_url();?>index.php/cms/files"><button class="btn btn-default">
				<i class="fa fa-chevron-left" aria-hidden="true"></i>
			</button></a>
			<br/><br/>
			<ol class="breadcrumb">
				<li class="breadcrumb-item"><a href="#">Home</a></li>
				<li class="breadcrumb-item active"><a href="<?php echo base_url();?>index.php/cms/files">Files</a></li>
