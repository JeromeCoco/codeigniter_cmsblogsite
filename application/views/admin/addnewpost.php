...
<html>
			...
			$("#btnpost").click(function(){
				...
				else
				{
					$.ajax({
				        ...
				        success: function(data)
				        {
				        	$("#err").html("<br/><div class='alert alert-success errmess' role='alert'><center>Your post was successfully saved.</center></div>");
				        	$("#title").val(" ");
	...
	<body>
		...
		<div class="containerko">
			<a href="<?php echo base_url();?>index.php/cms/posts"><button class="btn btn-default">
					<i class="fa fa-chevron-left" aria-hidden="true"></i>
			</button></a>
			<br/><br/>
			<ol class="breadcrumb">
				<li class="breadcrumb-item"><a href="#">Home</a></li>
				<li class="breadcrumb-item"><a href="<?php echo base_url();?>index.php/cms/posts">Posts</a></li>
				...
				<div class="row">
					<div class="col-sm-12">
						<form method="post">
							...
							<input id="title" type="text" class="form-control" placeholder="Post Title..."/><br/>
					...
					<div class="col-sm-5">
						<div id="publishSettings">
							...
							<br/>
							<input type="button" id="btnpost" value="Post" class="btn btn-md btn-success"/>
						</div>
					</div>
					<div class="col-sm-5">
						<div id="err"></div>
